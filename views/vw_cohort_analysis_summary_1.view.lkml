  ...
  derived_table: {
    sql: select MEDICAL.PATIENT_ID as MEDICAL_PATIENT_ID,  /*All Dimension of MEDICAL tab */
      ...
      FROM  (Select "UNIQUE_ID" as PATIENT_ID,
              ...
              from "SCH_KAIROS_ARKANSAS_MUNICIPAL_LEAGUE"."LKR_TAB_MEDICAL"
      ...
      LEFT JOIN
            ...
            From "SCH_KAIROS_ARKANSAS_MUNICIPAL_LEAGUE"."LKR_TAB_MEDICAL" as M1
        ...
        JOIN
            ...
            From "SCH_KAIROS_ARKANSAS_MUNICIPAL_LEAGUE"."LKR_TAB_PHARMACY" as P1
      ...
      LEFT JOIN
            ...
            From "SCH_KAIROS_ARKANSAS_MUNICIPAL_LEAGUE"."LKR_TAB_MEDICAL" as M2
        ...
        JOIN
            ...
            From "SCH_KAIROS_ARKANSAS_MUNICIPAL_LEAGUE"."LKR_TAB_PHARMACY" as P2
